                                ...
                                <button  style="Height:40px;">
                                    ...
                                    <div class="au-breadcrumb-right">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <% String name3=(String)request.getSession().getAttribute("manager"); %>
                                                <h4><%=name3 %></h4>
                                            </li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-30">
                            <div class="col-md-12">
                                <!-- DATA TABLE-->
                                <h3 class="title-5 m-b-35">Available Goods</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <div class="table-data-feature">
                                                        ...
                                                        <button onclick="myFunction()" class="item" data-toggle="tooltip" data-placement="top" title="Delete from table">
                                                        ...
                                                        <script>
                                                         ...
                                                         function myFunction(){
                                                        	 ...
                                                        	 document.getElementById("form1").deleteRow(0);
                                                         }
                                                        </script>

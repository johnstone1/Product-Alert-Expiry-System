...
<body>
    <div class="mian-content">
        ...
        <div class="header-top">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-3 login-right-img text-center text-white">
        ...
        <!-- main image slider container -->
            ...
            <div class="slide-wrapper" style="width:130%;">
                
               
                <div class="slide slide3 text-center">
                    <div class="slide-caption text-center">
                         <div class="card text-center w-75  col-md-12">
  <div class="card-header bg-secondary text-white">
    <h4>Contact us</h4>
  </div>
  <div class="card-body">
    <h5 class="card-title">By Phone</h5>
    <p class="card-text">(Monday to Saturday 7:am - 8:00 pm EAT)</p>
    <p class="card-text">(+254 715 582 733)</p>
    
    <h5 class="card-title">By Email</h5>
   <p> <a href="#">@peas.co.ke</a></p>
  </div>

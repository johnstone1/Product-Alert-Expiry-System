...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container2">
                                ...
                                <button  style="Height:40px;">
                                    ...
                                    <div class="au-breadcrumb-right">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <% String name7=(String)request.getSession().getAttribute("manager"); %>
                                                <h4><%=name7 %></h4>
                                            </li>
           ...
           <h3 class="card-title"><b>New Employee Registration</b></h3>
           </div>
           <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="../AddEmployeeServlet" class="form-sample" method="post">
                     
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Enter your Username </label>
                            <div class="col-sm-9">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Enter your First Name</label>
                            <div class="col-sm-9">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Enter National Id</label>
                            <div class="col-sm-9">
                              <input type="number" name="national" min="1" class="form-control" placeholder="id number" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Enter   Last Name</label>
                            <div class="col-sm-9">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Manager's Email_Address</label>
                            <div class="col-sm-9">

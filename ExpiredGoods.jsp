                                ...
                                <button  style="Height:40px;">
                                    ...
                                    <div class="au-breadcrumb-right">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <% String name2=(String)request.getSession().getAttribute("manager"); %>
                                                <h4><%=name2 %></h4>
                                            </li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-30">
                            <div class="col-md-12">
                                <!-- DATA TABLE-->
                                <h3 class="title-5 m-b-35">Expired Goods</h3>
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        try{
                                        	...
                                        	Connection con=DriverManager.getConnection(url5,Username,Password);
                                        	Statement st=con.createStatement();
                                        	
                                        	ResultSet rs=st.executeQuery("select * from expired_items");
